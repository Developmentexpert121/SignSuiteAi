...
[Current](https://www.postgresql.org/docs/current/libpq-ssl.html "PostgreSQL 18 - 32.19. SSL Support")
( [18](https://www.postgresql.org/docs/18/libpq-ssl.html "PostgreSQL 18 - 32.19. SSL Support"))


/

[17](https://www.postgresql.org/docs/17/libpq-ssl.html "PostgreSQL 17 - 32.19. SSL Support")


/

[16](https://www.postgresql.org/docs/16/libpq-ssl.html "PostgreSQL 16 - 32.19. SSL Support")


/

[15](https://www.postgresql.org/docs/15/libpq-ssl.html "PostgreSQL 15 - 32.19. SSL Support")


/

[14](https://www.postgresql.org/docs/14/libpq-ssl.html "PostgreSQL 14 - 32.19. SSL Support")

Development Versions:


[devel](https://www.postgresql.org/docs/devel/libpq-ssl.html "PostgreSQL devel - 32.19. SSL Support")

Unsupported versions:


[13](https://www.postgresql.org/docs/13/libpq-ssl.html "PostgreSQL 13 - 32.19. SSL Support")

/
[12](https://www.postgresql.org/docs/12/libpq-ssl.html "PostgreSQL 12 - 32.19. SSL Support")

/
[11](https://www.postgresql.org/docs/11/libpq-ssl.html "PostgreSQL 11 - 32.19. SSL Support")

/
[10](https://www.postgresql.org/docs/10/libpq-ssl.html "PostgreSQL 10 - 32.19. SSL Support")

/
[9.6](https://www.postgresql.org/docs/9.6/libpq-ssl.html "PostgreSQL 9.6 - 32.19. SSL Support")

/
[9.5](https://www.postgresql.org/docs/9.5/libpq-ssl.html "PostgreSQL 9.5 - 32.19. SSL Support")

/
[9.4](https://www.postgresql.org/docs/9.4/libpq-ssl.html "PostgreSQL 9.4 - 32.19. SSL Support")

/
[9.3](https://www.postgresql.org/docs/9.3/libpq-ssl.html "PostgreSQL 9.3 - 32.19. SSL Support")

/
[9.2](https://www.postgresql.org/docs/9.2/libpq-ssl.html "PostgreSQL 9.2 - 32.19. SSL Support")

/
[9.1](https://www.postgresql.org/docs/9.1/libpq-ssl.html "PostgreSQL 9.1 - 32.19. SSL Support")

/
[9.0](https://www.postgresql.org/docs/9.0/libpq-ssl.html "PostgreSQL 9.0 - 32.19. SSL Support")

/
[8.4](https://www.postgresql.org/docs/8.4/libpq-ssl.html "PostgreSQL 8.4 - 32.19. SSL Support")

/
[8.3](https://www.postgresql.org/docs/8.3/libpq-ssl.html "PostgreSQL 8.3 - 32.19. SSL Support")

/
[8.2](https://www.postgresql.org/docs/8.2/libpq-ssl.html "PostgreSQL 8.2 - 32.19. SSL Support")

/
[8.1](https://www.postgresql.org/docs/8.1/libpq-ssl.html "PostgreSQL 8.1 - 32.19. SSL Support")

/
[8.0](https://www.postgresql.org/docs/8.0/libpq-ssl.html "PostgreSQL 8.0 - 32.19. SSL Support")

| 32.19. SSL Support |
| :-: |
| [Prev](https://www.postgresql.org/docs/current/libpq-ldap.html "32.18. LDAP Lookup of Connection Parameters") | [Up](https://www.postgresql.org/docs/current/libpq.html "Chapter 32. libpq — C Library") | Chapter 32. libpq — C Library | [Home](https://www.postgresql.org/docs/current/index.html "PostgreSQL 18.3 Documentation") | [Next](https://www.postgresql.org/docs/current/libpq-oauth.html "32.20. OAuth Support") |

* * *

## 32.19. SSL Support [\#](https://www.postgresql.org/docs/current/libpq-ssl.html\#LIBPQ-SSL)

[32.19.1. Client Verification of Server Certificates](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBQ-SSL-CERTIFICATES)[32.19.2. Client Certificates](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-SSL-CLIENTCERT)[32.19.3. Protection Provided in Different Modes](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-SSL-PROTECTION)[32.19.4. SSL Client File Usage](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-SSL-FILEUSAGE)[32.19.5. SSL Library Initialization](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-SSL-INITIALIZE)

PostgreSQL has native support for using SSL connections to encrypt client/server communications using TLS protocols for increased security. See [Section 18.9](https://www.postgresql.org/docs/current/ssl-tcp.html "18.9. Secure TCP/IP Connections with SSL") for details about the server-side SSL functionality.
...
### 32.19.2. Client Certificates [\#](https://www.postgresql.org/docs/current/libpq-ssl.html\#LIBPQ-SSL-CLIENTCERT)
...
The first certificate in `postgresql.crt` must be the client's certificate because it must match the client's private key. “Intermediate” certificates can be optionally appended to the file — doing so avoids requiring storage of intermediate certificates on the server ( [ssl\_ca\_file](https://www.postgresql.org/docs/current/runtime-config-connection.html#GUC-SSL-CA-FILE)).

The certificate and key may be in PEM or ASN.1 DER format.

The key may be stored in cleartext or encrypted with a passphrase using any algorithm supported by OpenSSL, like AES-128. If the key is stored encrypted, then the passphrase may be provided in the [sslpassword](https://www.postgresql.org/docs/current/libpq-connect.html#LIBPQ-CONNECT-SSLPASSWORD) connection option. If an encrypted key is supplied and the `sslpassword` option is absent or blank, a password will be prompted for interactively by OpenSSL with a `Enter PEM pass phrase:` prompt if a TTY is available. Applications can override the client certificate prompt and the handling of the `sslpassword` parameter by supplying their own key password callback; see [`PQsetSSLKeyPassHook_OpenSSL`](https://www.postgresql.org/docs/current/libpq-connect.html#LIBPQ-PQSETSSLKEYPASSHOOK-OPENSSL).

For instructions on creating certificates, see [Section 18.9.5](https://www.postgresql.org/docs/current/ssl-tcp.html#SSL-CERTIFICATE-CREATION "18.9.5. Creating Certificates").

### 32.19.3. Protection Provided in Different Modes [\#](https://www.postgresql.org/docs/current/libpq-ssl.html\#LIBPQ-SSL-PROTECTION)
...
### 32.19.4. SSL Client File Usage [\#](https://www.postgresql.org/docs/current/libpq-ssl.html\#LIBPQ-SSL-FILEUSAGE)

[Table 32.2](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-SSL-FILE-USAGE "Table 32.2. Libpq/Client SSL File Usage") summarizes the files that are relevant to the SSL setup on the client.
...
`PQinitSSL` [#](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-PQINITSSL)
...
[`PQinitSSL`](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-PQINITSSL) and [`PQinitOpenSSL`](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-PQINITOPENSSL) are maintained for backwards compatibility, but are no longer required since PostgreSQL 18\. [`PQinitSSL`](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-PQINITSSL) has been present since PostgreSQL 8.0, while [`PQinitOpenSSL`](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-PQINITOPENSSL) was added in PostgreSQL 8.4, so [`PQinitSSL`](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-PQINITSSL) might be preferable for applications that need to work with older versions of libpq.

* * *

|     |     |     |
| --- | --- | --- |
| [Prev](https://www.postgresql.org/docs/current/libpq-ldap.html "32.18. LDAP Lookup of Connection Parameters") | [Up](https://www.postgresql.org/docs/current/libpq.html "Chapter 32. libpq — C Library") | [Next](https://www.postgresql.org/docs/current/libpq-oauth.html "32.20. OAuth Support") |
| 32.18. LDAP Lookup of Connection Parameters | [Home](https://www.postgresql.org/docs/current/index.html "PostgreSQL 18.3 Documentation") | 32.20. OAuth Support |
...
please use
[this form](https://www.postgresql.org/account/comments/new/18/libpq-ssl.html/)
